      ...
      <main className="max-w-7xl mx-auto px-4 mt-8">
        <div className="text-center mb-8 md:mb-12 max-w-6xl mx-auto w-full animate-in fade-in slide-in-from-top-4 duration-500">
          <div className="inline-block relative">
            <h1 className="text-4xl font-display font-bold text-[#1F2937] relative z-10 leading-tight">
          ...
          <div className="xl:col-span-7 flex flex-col">
            <div className="w-full bg-white rounded-3xl shadow-xl shadow-purple-100/50 border border-purple-50 p-6 md:p-10 relative overflow-hidden">
              ...
              <div className="mt-8 flex flex-col items-center justify-center relative z-10">
                <div className="w-full max-w-md bg-purple-50/50 border border-purple-100 rounded-xl p-4 mb-6 text-center">
                  <p className="text-xs text-gray-500 font-medium flex flex-col gap-1">
                    <span>⏳ Image takes 1-2 minutes to create</span>
                    <span>✨ For best results choose 1-3 verses maximum</span>
                  </p>
                </div>
