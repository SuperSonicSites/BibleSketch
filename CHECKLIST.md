...
0a. **On-site checkout: connected and tested, not yet on the pricing page** (plan §12.20 item 4).
   ...
   - [x] **Real purchase passed (2026-09-25 18:30 UTC, owner):** Spark through /checkout/spark went Stripe → Zoho webhook → +20 credits and +20 prints, and the account got its USD Zoho customer. Original item: buy Spark at https://biblesketch.app/checkout/spark (about $5.59 with tax) and check the 20 credits arrive. Refund it in Zoho afterwards if you like.
   - [x] **Live 2026-09-25** (at the owner's go, while the owner ran the test purchase): the pricing buttons open `/checkout/<plan>` (Worker 165fd10c); the uid field is hidden from customers in Zoho; the payment step asks only card, country, state and ZIP; the legal line reads "By paying, you agree to the Terms of Service and Privacy Policy" and its privacy link was fixed (it pointed to `biblesketch.app/=/privacy`); a Premium member can't buy the Prints plan, and someone on the Prints plan who upgrades to Premium is told to cancel the Prints plan.
