...
export const AGE_LOGIC = {
  [AgeGroup.TODDLER]: {
    keywords: "VECTOR-STYLE MONOLINE ART. Ultra-thick uniform black outlines (approx 4-5mm). 'Kawaii' mascot aesthetic. Shapes must be geometric, rounded, and bubble-like. NO sharp angles, NO texture, NO sketching lines. Maximum white space.",
    subjectFocus: "Focus on a single isolated subject. No complex crowds. Visuals must be iconic and instantly recognizable."
  },
  [AgeGroup.YOUNG_CHILD]: {
    keywords: "STORYBOOK LINE ART. Consistent, medium-thick outlines (approx 2mm). Focus on clear object separation. Detailed environments are acceptable (water, sky) but must maintain large, colorable segments.",
...
export const STYLE_LOGIC = {
  ...
  [ArtStyle.COMIC]: "Dynamic comic book shading, action lines, dramatic lighting, bold inking.",
